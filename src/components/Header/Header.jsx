         ...
         <div className="header_wrap">
               ...
               <ul>
                  <li className='drops'>
                     ...
                     <ul className='sub-menu' ref={subMenuRef}>
                        ...
                        <li>
                           <Link
                              to='/product/retargeting-trigger-leads'
                           >
                  ...
                  <li>
                     <Link to='/price'
                        className={isActiveLink('/price') ? 'current-link' : ''}
                     >
                        Стоимость
                     </Link>
                  </li>
                  <li>
                     <a href='https://reffection.ru/blog'
                        className={isActiveLink('/blog') ? 'current-link' : ''}
                     >
                        Блог
                     </a>
                  </li>
                  <li>
                     <Link to='/partners'
                        className={isActiveLink('/partners') ? 'current-link' : ''}
                     >
                        Партнерам
                     </Link>
                  </li>
                  <li>
                     <Link to='/contacts'
                        className={isActiveLink('/contacts') ? 'current-link' : ''}
                     >
                        Контакты
                     </Link>
                  </li>
            ...
            <div className="header_wrap_right">
               ...
               <BtnLink
                  ...
                  label={'Telegram'}
                  target={'_blank'}
                  className={`header_wrap_right-btn ${routesChangeColor.includes(location.pathname) ? location.pathname.replace('/', '') : ''}`}
               >
                  <div className="icon">
               ...
               {isMobile &&
                  <button type='button'
                     className={`header_wrap_right-burger btn light_gray`}
                     onClick={() => openModal()}
                  >
                     Меню
                  </button>
