            ...
            <div className='infoblock_wrap'>
               ...
               <div className='infoblock_wrap_box'>
                  <CustomText className="small">
                     ...
                     <p>Я подтверждаю, что ознакомился с Политикой обработки персональных данных Reffection, расположенной по адресу: <Link to="/privacy-third">https://reffection.ru/privacy-third</Link></p>
...
export default ConsentInfoThird;