...
function ReviewsSwiperKitchens() {
    ...
    return (
        <div className='rev_swiper_block kitchens'>
            <h2 className='rev_swiper_block-title section_title white'>Результат для клиента </h2>
                                    ...
                                    <div className="sw_rev_item_right_list row">
                                        <div className="col-xl-6 col-6">
                                            <div className="sw_rev_item_right_list_item">
                                                <div className="sw_rev_item_right_list_item-title">
                                                    Собрано
                                                </div>
