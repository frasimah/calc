...
const ServiceSelector = ({ serviceType, onServiceChange, isDropdownOpen, onToggleDropdown, onInfoClick, onInfoClickContent }) => (
    <div className="product-section">
        <div className="section-title-container">
            <label htmlFor="serviceTypeSelector" className="section-title">Выберите продукт</label>
            <InfoIcon onClick={() => {
                onInfoClick()
