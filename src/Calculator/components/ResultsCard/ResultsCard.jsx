                ...
                <div className="results-list">
                    ...
                    <div className="result-item">
                        <span className="result-text">
                            {serviceType === 3 ? "Стоимость обработки" : "Стоимость данных"}: {contacts > 0 && results.totalCost > 0 ? (results.dataPricePerUnit || Math.round(results.totalCost / contacts)) : 0}₽/ед
                        </span>
                    </div>
                    ...
                    <div className="result-item">
                        <span className="result-text">Стоимость лида: {results.expectedConversions > 0 ? formatNumber(results.costPerConversion) : 0} ₽</span>
                    </div>
                </div>
